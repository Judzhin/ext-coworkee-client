Ext.define('Coworkee.view.viewport.ViewportController', {
    ...
    onLaunch: function() {
        this.originalRoute = Coworkee.getApplication().getDefaultToken();
        this.initDirect();
        this.restoreSession();
    },
    ...
    handleUnmatchedRoute: function(route) {
        ...
        var target = Coworkee.getApplication().getDefaultToken();
    ...
    restoreSession: function() {
        var data = Coworkee.util.State.get('session'),
            session = data? Coworkee.model.Session.loadData(data) : null;
    ...
    saveSession: function(session) {
        Coworkee.util.State.set('session', session && session.getData(true));
